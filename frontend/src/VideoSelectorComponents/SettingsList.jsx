...
const SettingsList = ({ settingsObj, setSettingsObj }) => {
        ...
        <div className="settings-list-wrapper">
            ...
            <div className="settings-list-content">
                ...
                <div className="settings-list-row">
                    <h3>UI Color</h3>
                    <div className="settings-list-row-content">
                        <button id="theme-button" onClick={handleThemeToggle}></button>
                    </div>
                </div>
                <div className="settings-list-row">
                    <h3>Video Saturation</h3>
                    <div className="settings-list-row-content">
                        <StepperButton min={0.0} max={3.0} start={videoSaturation} step={0.2} round={1} setVal={setVideoSaturation}></StepperButton>
                    </div>
                </div>
                <div className="settings-list-row">
                    <h3>Video Brightness</h3>
                    <div className="settings-list-row-content">
                        <StepperButton min={0.1} max={1.4} start={videoBrightness} step={0.05} round={2} setVal={setVideoBrightness}></StepperButton>
                    </div>
                </div>
                <div className="settings-list-row">
