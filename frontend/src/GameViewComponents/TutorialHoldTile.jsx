...
const TutorialHoldTile = ({ type, tileSpeed, theme, targetTime, elapseBeatCount, elapseTime, onMount, onMiss, updateScoreAndCombo, reset, id }) => {
    ...
    const handleDown = (e) => {
        if (!tapped.current) {
            if ((e.key == "d" && type == "left") || (e.key == "k" && type == "right")) {
...
export default TutorialHoldTile